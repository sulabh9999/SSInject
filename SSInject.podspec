#
#  Be sure to run `pod spec lint SSinject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SSinject"
  s.version      = "1.0.0	"
  s.summary      = "A short description of SSinject."
  ...
  s.source       = { :git => "https://github.com/sulabh9999/SSInject.git", :branch => "master" :tag => "#{s.version}" }
